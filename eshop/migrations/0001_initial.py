    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('DI', 'Director'), ('AD', 'Администратор'), ('CO', 'Повар'), ('CA', 'Кассир'), ('CL', 'Уборщик')], default='CA', max_length=2)),
        ...
        migrations.AddField(
            model_name='order',
            name='products',
            field=models.ManyToManyField(through='eshop.ProductOrder', to='eshop.product'),
        ),
        migrations.AddField(
            model_name='order',
            name='staff',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eshop.staff'),
        ),
    ]
